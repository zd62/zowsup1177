...
class SetKeysIqProtocolEntity(IqProtocolEntity):
    def __init__(self, identityKey, signedPreKey, preKeys, djbType, registrationId = None) -> None:
        super().__init__("encrypt", _type = "set", to = YowConstants.WHATSAPP_SERVER)
        self.setProps(identityKey, signedPreKey, preKeys, djbType, registrationId)

    def setProps(self, identityKey, signedPreKey, preKeys, djbType, registrationId = None) -> Any:

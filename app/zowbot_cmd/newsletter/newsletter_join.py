"""newsletter.join command module with full implementation extraction"""
...
class Cmd_Newsletter_Join(BotCommand):

    COMMAND = "newsletter.join"
    DESCRIPTION = "Join newsletter"
